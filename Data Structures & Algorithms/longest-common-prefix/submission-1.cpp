...
public:
    string longestCommonPrefix(vector<string>& strs) {
        ...
        // 2nd Approach 
        // since we have to preserve the order , we can use vector or string to store elements.
        // string would be better as it has null character automatically
        // we will store the 1st string of the loop as ans and remove its last letter or increment j value     
